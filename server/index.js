...
app.post("/api/orders", async (req, res, next) => {
  try {
    ...
    // Fire-and-forget: don't make the customer wait on Telegram, and never
    // let a notification hiccup fail the order itself.
    sendTelegramMessage(formatOrderNotification(order));
